...
ReactDOM.render(
 ...
 // Provider - component from React Redux - wrap around entire application because we want everything inside to have access to the store (App State) that we get from Redux
 <Provider>
  <BrowserRouter>
    <App/>
  </BrowserRouter>
